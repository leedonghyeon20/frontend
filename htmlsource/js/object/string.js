...
console.log(`특정 문자 위치 반환 : ${msg1.includes("j")}`);
...
console.log(`문자열 찾기 : ${msg1.match("ja")}`); // ja
console.log(`문자열 찾기 : ${msg1.match("wu")}`); // null
console.log(`문자열 위치 찾기 : ${msg1.search("ja")}`); // 6 위치
console.log(`문자열 위치 찾기 : ${msg1.search("wu")}`); // -1
