// 배열 생성
const fruits = ["사과", "망고", "바나나", "키위", "포도", "자두"];
...
console.log("오름차순 배열 정렬 " + array2.sort((a, b) => a - b));
console.log("내림차순 배열 정렬 " + array2.sort((a, b) => b - a));
...
// 얕은 복사(주소 복사), 깊은 복사(값 복사-서로 다른 주소값)
